...
const AdminLog = () => {
  ...
  return (
    <div className="flex border-2 border-[#202758] p-6 rounded-b-xl">
      <form
      ...
      >
        <div className="flex justify-center w-full mb-3">
          <svg
            className="w-16 h-16 text-[#202758] mt-3 mb-4"
            aria-hidden="true"
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
            viewBox="0 0 20 20"
        ...
        {!auth ? (
          <button
            className="mt-5 py-2 bg-[#202758] text-white rounded-full w-2/3 border-2 border-white hover:bg-white hover:text-sky-800 hover:border-2 hover:border-sky-800"
            type="submit"
          >
            {" "}
            Log In
