...
export const createConst = (values: Record<string, any>) => new constModel(values).save().then((cons)=> cons.toObject());
export const deleteConstById = (id: String) => constModel.findOneAndDelete({ id : id });
export const updateConst = (id: String, values: Record<string, any>) => constModel.findOneAndUpdate({id:id},values, {new: true}); 
